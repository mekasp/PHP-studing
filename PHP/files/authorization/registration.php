...
if ($result['result']){
    ...
    $file = fopen('users/' . $_POST['name'] . '.txt','w+');

    $content = ['email' => $_POST['email'],'name' => $_POST['name'],'phone' => $_POST['phone'],'password' => $_POST['password']];
...
<body>
    ...
    <a href="http://php.local/files/authorization/login.php">Войти</a>
</body>
</html>
